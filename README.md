...
## [섹션 9. 타임리프 - 기본 기능](./thymeleaf-basic/)

## 섹션 10. 타임리프 - 스프링 통합과 폼
...
113. 타입 컨버터 - Converter

114. 컨버전 서비스 - ConversionService

115. 스프링에 Converter 적용하기

116. 뷰 템플릿에 컨버터 적용하기

117. 포맷터 - Formatter

118. 포맷터를 지원하는 컨버전 서비스

119. 포맷터 적용하기

120. 스프링이 제공하는 기본 포맷터
